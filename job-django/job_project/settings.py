...
SECRET_KEY = 'django-insecure-z@yocbtv*fd!pjhi)61g2zdf(*^hj5nckw4vm(xufn(2$!8+9x'
...
INSTALLED_APPS = [
    ...
    'jobs',  # Thêm ứng dụng jobs vào danh sách
]
...
DATABASES = {
    'default': {
        'ENGINE': 'mssql',
        'NAME': 'vieclam',  # Tên cơ sở dữ liệu
        'USER': 'sa',  # Tên người dùng SQL Server
        'PASSWORD': '123',  # Mật khẩu SQL Server
        'HOST': '127.0.0.1',  # Địa chỉ máy chủ SQL Server
